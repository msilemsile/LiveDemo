 ...
 */
package me.msile.train.livedemo.utils.floatpermission;
...
public class FloatWindowUtils {
     ...
     * 是否可以开启悬浮权限
     */
    public boolean canShowFloatWindow(Context context, boolean needApplyPermission) {
        boolean canShowFloatWindow = checkPermission(context);
